...
{
pst=con.prepareStatement("select * from products where vehical_brand=? and catid=(select catid from products where prodnm=?);");
...
{
pst=con.prepareStatement("select * from products where vehical_brand=? and catid=(select catid from prod_cat where catnm=?);");
pst.setString(1, brand);
pst.setString(2, searchitem);
rs=pst.executeQuery();
while(rs.next())
...
{
pst=con.prepareStatement("select * from products where vehical_brand=?;");
pst.setString(1, brand);
